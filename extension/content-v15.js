...
(function () {
  ...
  const ICONS = {
    ...
    megaphone: `<svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 10v4a1 1 0 0 0 1 1h2l9 5V4l-9 5H4a1 1 0 0 0-1 1z"/><path d="M17 9.5a4 4 0 0 1 0 5"/></svg>`,
    scissors: `<svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="6" r="2.5"/><circle cx="6" cy="18" r="2.5"/><path d="M20 6 8 18M8 6l12 12"/></svg>`,
  };
  ...
  function buildShell() {
    ...
    rail.innerHTML = `
      ...
      <button class="crm-rail-btn" data-go="campanhas" data-label="Campanhas">${ICONS.megaphone}</button>
      <button class="crm-rail-btn" data-go="pos-venda" data-label="Pós-venda / Retorno">${ICONS.scissors}</button>
