  ...
  public: {
    Tables: {
      ...
      saved_campaigns: {
        ...
        Relationships: [
          {
            foreignKeyName: "saved_campaigns_barbershop_id_fkey";
            columns: ["barbershop_id"];
            isOneToOne: false;
            referencedRelation: "barbershops";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "saved_campaigns_catalog_campaign_id_fkey";
            columns: ["catalog_campaign_id"];
            isOneToOne: false;
            referencedRelation: "campaign_catalog";
            referencedColumns: ["id"];
          },
        ];
      };
