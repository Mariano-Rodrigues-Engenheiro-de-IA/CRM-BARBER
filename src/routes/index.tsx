...
function Landing() {
  ...
  const [form, setForm] = useState({ name: "", email: "", phone: "", business_type: "barbearia" as "barbearia" | "odontologia" | "estetica" });
          ...
          <form onSubmit={onSubmit} className="mt-6 space-y-4">
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, business_type: e.target.value as "barbearia" | "odontologia" | "estetica" }))
                }
