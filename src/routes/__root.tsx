...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "CRM de Assinaturas para Barbearias no WhatsApp" },
      { property: "og:description", content: "Extensão de Chrome que transforma seu WhatsApp Web em um CRM de assinaturas: cobre inadimplentes, reative clientes e dispare campanhas sem trocar de ferramenta." },
      { name: "twitter:description", content: "Extensão de Chrome que transforma seu WhatsApp Web em um CRM de assinaturas: cobre inadimplentes, reative clientes e dispare campanhas sem trocar de ferramenta." },
