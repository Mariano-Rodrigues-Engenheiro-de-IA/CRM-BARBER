...
export const Route = createFileRoute("/baixar")({
  head: () => ({
    meta: [
      { title: "Baixar pacote da extensão v0.33.4 | CRM Assinaturas" },
      {
        name: "description",
        content:
          "Download direto do pacote .zip da extensão CRM Assinaturas v0.33.4, pronto para upload no Chrome Web Store Developer Dashboard.",
      },
      { property: "og:title", content: "Baixar pacote da extensão v0.33.4" },
      {
...
const FILE = "/crm-assinaturas-extension-v3304.zip";
