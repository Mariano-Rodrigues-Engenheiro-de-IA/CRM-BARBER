...
export const Route = createFileRoute("/baixar")({
  head: () => ({
    meta: [
      { title: "Baixar pacote da extensão v0.33.3 | CRM Assinaturas" },
      {
        name: "description",
        content:
          "Download direto do pacote .zip da extensão CRM Assinaturas v0.33.3, pronto para upload no Chrome Web Store Developer Dashboard.",
      },
      { property: "og:title", content: "Baixar pacote da extensão v0.33.3" },
      {
...
const FILE = "/crm-assinaturas-extension-v3303.zip";
