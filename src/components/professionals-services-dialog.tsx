...
/** Aba de Profissionais — standalone, reaproveitada tanto na tela de
 * Configurações quanto (via dialog) dentro da própria Agenda. */
...
/** Aba de Serviços — standalone, mesmo padrão da de Profissionais. */
...
/** Dialog com as duas abas juntas — usado como atalho rápido dentro da
