...
// Conversa adaptada pro contexto de clínica (lead perguntando sobre
// implante, IA respondendo e fechando o horário) — o componente
// original vem com uma conversa genérica entre amigos, trocada aqui
// pelo cenário real do produto.
const DEFAULT_MESSAGES: ChatMessage[] = [
  {
    id: 1,
    sender: "Lead",
    avatarInitial: "L",
    text: "Oi, vi o anúncio de vocês no Instagram. Fazem avaliação pra implante?",
    isCurrentUser: false,
    timestamp: "10:11",
  },
  {
    ...
    sender: "Lead",
    avatarInitial: "L",
    text: "E dá pra parcelar o tratamento?",
    isCurrentUser: false,
    timestamp: "10:11",
  },
  {
    ...
    sender: "Você",
    avatarInitial: "V",
    text: "Oi! Fazemos sim, a avaliação é gratuita 😊 E dá pra parcelar em até 12x, a dentista passa os valores certinhos na consulta.",
    isCurrentUser: true,
    timestamp: "10:12",
  },
  {
    ...
    sender: "Lead",
    avatarInitial: "L",
    text: "Perfeito! Vocês têm horário essa semana?",
    isCurrentUser: false,
    timestamp: "10:13",
  },
  {
    ...
    sender: "Você",
    avatarInitial: "V",
    text: "Tenho quinta às 14h ou sexta às 10h 👍",
    isCurrentUser: true,
    timestamp: "10:13",
  },
];
...
export function MobileMockup({
  ...
  useEffect(() => {
    ...
    let t1: ReturnType<typeof setTimeout>,
      ...
      tReset: ReturnType<typeof setTimeout>;
...
/**
 * Componente base: Great UI (great-ui.com), licença MIT.
 * Adaptado pro contexto do Zaylo CRM (conteúdo da conversa, textos em
 * português) — estrutura e lógica do componente mantidas fiéis ao
 * original.
 */
